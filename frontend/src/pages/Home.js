    ...
    <div className="min-h-screen bg-gtaBlack text-gtaWhite px-6 py-12">
      ...
      <div className="grid gap-8 md:grid-cols-2 max-w-5xl mx-auto mt-10">
        <div className="bg-gtaBlack border border-gtaAccent p-6 rounded-lg shadow-gta">
          <h2 className="text-xl font-gta text-gtaAccent">📝 Upload Mission Notes</h2>
        ...
        <div className="bg-gtaBlack border border-gtaAccent p-6 rounded-lg shadow-gta">
          <h2 className="text-xl font-gta text-gtaAccent">🧠 Smart Flashcard Arsenal</h2>
          <p className="text-gtaWhite/80">
        ...
        <div className="bg-gtaBlack border border-gtaAccent p-6 rounded-lg shadow-gta">
          <h2 className="text-xl font-gta text-gtaAccent">🔁 Share with Your Crew</h2>
          <p className="text-gtaWhite/80">
        ...
        <div className="bg-gtaBlack border border-gtaAccent p-6 rounded-lg shadow-gta">
          <h2 className="text-xl font-gta text-gtaAccent">📅 Study Plan Control Panel</h2>
          <p className="text-gtaWhite/80">
        ...
        <div className="bg-gtaBlack border border-gtaAccent p-6 rounded-lg shadow-gta">
          <h2 className="text-xl font-gta text-gtaAccent">🤖 Ask AI Tutor</h2>          <p className="text-gtaWhite/80">
    Got questions? Drop them like clues before a big job. Your AI tutor’s got your back — street smart, sharp, and ready to break it down.
          </p>
        </div>

        <div className="bg-gtaBlack border border-gtaAccent p-6 rounded-lg shadow-gta">
  <h2 className="text-xl font-gta text-gtaAccent">🎯 Quiz Mission</h2>
  <p className="text-gtaWhite/80">
    Enter challenge mode with AI-generated questions from your notes. Study smarter, earn your stars.
  </p>
</div>
